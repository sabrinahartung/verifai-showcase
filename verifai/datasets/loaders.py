...
def load_ham10000(spec: dict[str, Any]) -> ImageDataset:
    ...
    """
    from verifai.models.image import CLASSES
    ...
    with open(manifest, newline="", encoding="utf-8") as f:
        for row in csv.DictReader(f):
            ...
            samples.append(ImageSample(id=Path(fname).stem, path=images_dir / fname, label=label))
    ...
    return ImageDataset(
        ...
        meta={"manifest": str(manifest), "images_dir": str(images_dir), "source": "HAM10000"},
    )
